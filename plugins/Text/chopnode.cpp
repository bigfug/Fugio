...
void ChopNode::inputsUpdated( qint64 pTimeStamp )
{
...
QUuid ChopNode::pairedPinControlUuid( QSharedPointer<fugio::PinInterface> pPin ) const
{
	return( pPin->direction() == PIN_INPUT ? PID_STRING : PID_STRING );
}

QList<QUuid> ChopNode::pinAddTypesInput() const
{
...
bool ChopNode::canAcceptPin( fugio::PinInterface *pPin ) const
{
