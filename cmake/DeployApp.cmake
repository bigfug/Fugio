...
install( CODE "execute_process( COMMAND \"${WINDEPLOYQT_EXECUTABLE}\" --concurrent --opengl --serialport --websockets --compiler-runtime --no-angle --no-opengl-sw --force --verbose 2 --qmldir \"${CMAKE_SOURCE_DIR}/qml\" \"${CMAKE_INSTALL_PREFIX}/${PATH_APP}/${PROJECT_NAME}.exe\" )"
